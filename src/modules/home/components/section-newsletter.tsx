...
export default memo(function SectionNewsletter() {
  return (
    <section
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <form action="#" method="POST" className="max-w-xl mx-auto mt-12">
          <div className="flex flex-col items-center sm:flex-row sm:justify-center">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center w-auto px-4 py-4 mt-4 font-semibold text-white transition-all duration-200
              bg-color-second-theme border border-transparent rounded-md sm:ml-4 sm:mt-0 sm:w-auto"
            >
              Subscribe
              <svg
